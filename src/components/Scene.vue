...
<script>
  ...
  export default {
    ...
    async created () {
      ...
      await this.addMessage({type: 'own', text: 'Register', time: '22:51'})
      await this.addMessage({type: 'response', text: 'What is your e-mail?', time: '22:51'})
      await this.addMessage({type: 'own', text: 'k.gerasimenko@gl.com', time: '22:51'})
      await this.addMessage({
        type: 'response',
        text: 'Please enter registration code sent to your e-mail',
        time: '22:51'
      }, 900)
      await this.addMessage({type: 'own', text: '21737', time: '22:51'})
      await this.addMessage({
        type: 'response',
      ...
      //   this.$store.commit('CLEAR_MESSAGES')
      //
      await this.addMessage({type: 'own', text: 'Lurk', time: '12:51'})
      await this.addMessage({
        type: 'response',
